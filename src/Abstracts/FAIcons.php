 ...
 * @author allan
 */
abstract class FAIcons
{

    const FA_500PX                               = "fa-500px";
    const FA_ADDRESS_BOOK                        = "fa-address-book";
    const FA_ADDRESS_BOOK_O                      = "fa-address-book-o";
    const FA_ADDRESS_CARD                        = "fa-address-card";
    const FA_ADDRESS_CARD_O                      = "fa-address-card-o";
    ...
    const FA_ASL_INTERPRETING                    = "fa-asl-interpreting";
    ...
    const FA_AUTOMOBILE                          = "fa-automobile";
    const FA_BACKWARD                            = "fa-backward";
    const FA_BALANCE_SCALE                       = "fa-balance-scale";
    const FA_BAN                                 = "fa-ban";
    const FA_BANDCAMP                            = "fa-bandcamp";
    const FA_BANK                                = "fa-bank";
    const FA_BAR_CHART                           = "fa-bar-chart";
    const FA_BAR_CHART_O                         = "fa-bar-chart-o";
    const FA_BARCODE                             = "fa-barcode";
    const FA_BARS                                = "fa-bars";
    const FA_BATH                                = "fa-bath";
    const FA_BATHTUB                             = "fa-bathtub";
    const FA_BATTERY                             = "fa-battery";
    const FA_BATTERY_0                           = "fa-battery-0";
    const FA_BATTERY_1                           = "fa-battery-1";
    const FA_BATTERY_2                           = "fa-battery-2";
    const FA_BATTERY_3                           = "fa-battery-3";
    const FA_BATTERY_4                           = "fa-battery-4";
    ...
    const FA_DASHBOARD                           = "fa-dashboard";
    const FA_DASHCUBE                            = "fa-dashcube";
    const FA_DATABASE                            = "fa-database";
    const FA_DEAF                                = "fa-deaf";
    const FA_DEAFNESS                            = "fa-deafness";
    const FA_DEDENT                              = "fa-dedent";
    ...
    const FA_DRIVERS_LICENSE                     = "fa-drivers-license";
    const FA_DRIVERS_LICENSE_O                   = "fa-drivers-license-o";
    const FA_DROPBOX                             = "fa-dropbox";
    const FA_DRUPAL                              = "fa-drupal";
    const FA_EDGE                                = "fa-edge";
    const FA_EDIT                                = "fa-edit";
    const FA_EERCAST                             = "fa-eercast";
    ...
    const FA_FILE_MOVIE_O                        = "fa-file-movie-o";
    const FA_FILE_O                              = "fa-file-o";
    const FA_FILE_PDF_O                          = "fa-file-pdf-o";
    const FA_FILE_PHOTO_O                        = "fa-file-photo-o";
    const FA_FILE_PICTURE_O                      = "fa-file-picture-o";
    const FA_FILE_POWERPOINT_O                   = "fa-file-powerpoint-o";
    const FA_FILE_SOUND_O                        = "fa-file-sound-o";
    ...
    const FA_FILE_ZIP_O                          = "fa-file-zip-o";
    ...
    const FA_GBP                                 = "fa-gbp";
    const FA_GE                                  = "fa-ge";
    const FA_GEAR                                = "fa-gear";
    const FA_GEARS                               = "fa-gears";
    ...
    const FA_GOOGLE_PLUS_CIRCLE                  = "fa-google-plus-circle";
    const FA_GOOGLE_PLUS_OFFICIAL                = "fa-google-plus-official";
    ...
    const FA_HAND_STOP_O                         = "fa-hand-stop-o";
    const FA_HANDSHAKE_O                         = "fa-handshake-o";
    const FA_HARD_OF_HEARING                     = "fa-hard-of-hearing";
    ...
    const FA_HOURGLASS_1                         = "fa-hourglass-1";
    const FA_HOURGLASS_2                         = "fa-hourglass-2";
    const FA_HOURGLASS_3                         = "fa-hourglass-3";
    ...
    const FA_ID_CARD_O                           = "fa-id-card-o";
    const FA_ILS                                 = "fa-ils";
    ...
    const FA_INSTITUTION                         = "fa-institution";
    const FA_INTERNET_EXPLORER                   = "fa-internet-explorer";
    const FA_INTERSEX                            = "fa-intersex";
    ...
    const FA_MAIL_FORWARD                        = "fa-mail-forward";
    const FA_MAIL_REPLY                          = "fa-mail-reply";
    const FA_MAIL_REPLY_ALL                      = "fa-mail-reply-all";
    ...
    const FA_QUESTION_CIRCLE_O                   = "fa-question-circle-o";
    ...
    const FA_REMOVE                              = "fa-remove";
    const FA_RENREN                              = "fa-renren";
    const FA_REORDER                             = "fa-reorder";
    const FA_REPEAT                              = "fa-repeat";
    const FA_REPLY                               = "fa-reply";
    const FA_REPLY_ALL                           = "fa-reply-all";
    const FA_RESISTANCE                          = "fa-resistance";
    const FA_RETWEET                             = "fa-retweet";
    const FA_RMB                                 = "fa-rmb";
    const FA_ROAD                                = "fa-road";
    const FA_ROCKET                              = "fa-rocket";
    const FA_ROTATE_LEFT                         = "fa-rotate-left";
    const FA_ROTATE_RIGHT                        = "fa-rotate-right";
    const FA_ROUBLE                              = "fa-rouble";
    const FA_RSS                                 = "fa-rss";
    const FA_RSS_SQUARE                          = "fa-rss-square";
    const FA_RUB                                 = "fa-rub";
    const FA_RUBLE                               = "fa-ruble";
    const FA_RUPEE                               = "fa-rupee";
    const FA_S15                                 = "fa-s15";
    ...
    const FA_SEND                                = "fa-send";
    const FA_SEND_O                              = "fa-send-o";
    ...
    const FA_SHEKEL                              = "fa-shekel";
    const FA_SHEQEL                              = "fa-sheqel";
    ...
    const FA_SNOWFLAKE_O                         = "fa-snowflake-o";
    const FA_SOCCER_BALL_O                       = "fa-soccer-ball-o";
    ...
    const FA_STAR_HALF_EMPTY                     = "fa-star-half-empty";
    const FA_STAR_HALF_FULL                      = "fa-star-half-full";
    ...
    const FA_THERMOMETER_0                       = "fa-thermometer-0";
    const FA_THERMOMETER_1                       = "fa-thermometer-1";
    const FA_THERMOMETER_2                       = "fa-thermometer-2";
    const FA_THERMOMETER_3                       = "fa-thermometer-3";
    const FA_THERMOMETER_4                       = "fa-thermometer-4";
    ...
    const FA_TIMES_RECTANGLE                     = "fa-times-rectangle";
    const FA_TIMES_RECTANGLE_O                   = "fa-times-rectangle-o";
    const FA_TINT                                = "fa-tint";
    const FA_TOGGLE_DOWN                         = "fa-toggle-down";
    const FA_TOGGLE_LEFT                         = "fa-toggle-left";
    const FA_TOGGLE_OFF                          = "fa-toggle-off";
    const FA_TOGGLE_ON                           = "fa-toggle-on";
    const FA_TOGGLE_RIGHT                        = "fa-toggle-right";
    const FA_TOGGLE_UP                           = "fa-toggle-up";
    ...
    const FA_TURKISH_LIRA                        = "fa-turkish-lira";
    const FA_TV                                  = "fa-tv";
    ...
    const FA_VCARD                               = "fa-vcard";
    const FA_VCARD_O                             = "fa-vcard-o";
    ...
    const FA_VK                                  = "fa-vk";
    const FA_VOLUME_CONTROL_PHONE                = "fa-volume-control-phone";
    ...
    const FA_Y_COMBINATOR_SQUARE                 = "fa-y-combinator-square";
    const FA_YAHOO                               = "fa-yahoo";
    const FA_YC                                  = "fa-yc";
    const FA_YC_SQUARE                           = "fa-yc-square";
