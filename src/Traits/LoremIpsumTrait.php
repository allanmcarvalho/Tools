...
/**
 * Description of LoremIpsumTrait
 *
 * @author allan
 */
trait LoremIpsumTrait
{
     ...
     */
    protected function _word($tags = false)
    {
        return $this->_words(1, $tags);
    }
     ...
     */
    protected function _wordsArray($count = 1, $tags = false)
    {
        return $this->_words($count, $tags, true);
    }
     ...
     */
    protected function _words($count = 1, $tags = false, $array = false)
    {
        $words      = array();
        $word_count = 0;
     ...
     */
    protected function _sentence($tags = false)
    {
        return $this->_sentences(1, $tags);
    }
     ...
     */
    protected function _sentencesArray($count = 1, $tags = false)
    {
        return $this->_sentences($count, $tags, true);
    }
     ...
     */
    protected function _sentences($count = 1, $tags = false, $array = false)
    {
        $sentences = array();
        for ($i = 0; $i < $count; $i++)
        {
            $sentences[] = $this->_wordsArray($this->gauss(24.46, 5.08));
        }
     ...
     */
    protected function _paragraph($tags = false)
    {
        return $this->_paragraphs(1, $tags);
    }
     ...
     */
    protected function _paragraphsArray($count = 1, $tags = false)
    {
        return $this->_paragraphs($count, $tags, true);
    }
     ...
     */
    protected function _paragraphs($count = 1, $tags = false, $array = false)
    {
        $paragraphs = array();
        for ($i = 0; $i < $count; $i++)
        {
            $paragraphs[] = $this->_sentences($this->gauss(5.8, 1.93));
        }
